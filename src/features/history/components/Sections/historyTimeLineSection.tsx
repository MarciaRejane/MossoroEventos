...
export function HistoryTimeLineSection() {
  return (
    <section className=" py-10 px-2 lg:px-8 space-y-10">
      <div className="flex flex-col justify-center items-center space-y-10 text-center px-2 lg:px-8">
        <h2 className="text-blue-5 text-2xl lg:text-3xl font-bold">Uma História de Resistência</h2>
