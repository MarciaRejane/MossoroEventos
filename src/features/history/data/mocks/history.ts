...
export const TIMELINE_ITEMS: History[] = [
  {
    ...
    imageUrl: "/assets/history/tudo-comecou.png",
    description:
...

  {
    ...
    imageUrl: "/assets/history/motim-historia.png",
    description:
...

  {
    ...
    imageUrl: "/assets/history/historia-escravatura.png",
    description:
...

  {
    ...
    imageUrl: "/assets/history/historia-resistencia.png",
    description:
...

  {
    ...
    year: 1928,
    title: "Voto Feminino",
    imageUrl: "/assets/history/historia-femininoVoto.png",
    description:
...

  {
    ...
    label: "Atualidade",
    title: "Mossoró Hoje",
    imageUrl: "/assets/history/historia-mossoro-hoje.png",
    description:
